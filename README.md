...
Then open [http://127.0.0.1:8765](http://127.0.0.1:8765) (the Python process, not `ui/index.html` as a static file). Opening the HTML file or a Cursor file preview without that server cannot generate secrets.
